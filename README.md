...
|로그인|회원가입|
|:---:|:---:|
|<img src="" width="450"/>|<img width="450" alt="회원가입" src="https://github.com/user-attachments/assets/a665f3ad-4575-48e2-a373-0b385183e12c" />|
|아이디와 비밀번호 입력 후 로그인 가능. <br /> 회원가입 페이지로 이동 가능.|프로필 사진을 업로드하고, 이메일, 비밀번호, 닉네임을 입력하여 가입 가능.|
